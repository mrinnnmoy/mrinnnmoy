...
![banner image](./web3-banner.png)

🔭 **About Me:**

- 👨‍💻 Building Production-grade Web3 systems across multiple chains.
- 🛠️ Skilled in **C++, JavaScript, TypeScript, Solidity & Rust**.
- 📝 Blockchain enthusiast writing blogs on [Hashnode](https://mrinmoy.hashnode.dev).
- 💡 Exploring **Zero-knowledge Proofs** & **Decentralized Financial** systems.
